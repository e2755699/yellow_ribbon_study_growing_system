...
class DailyPerformancePageWidgetState extends State<DailyPerformancePageWidget>
  ...
  Widget _mainSection(BuildContext context) {
    return BlocBuilder<DailyPerformanceCubit,
        StudentDailyPerformanceState>(builder: (context, state) {
        ...
        builder: (context, searchText, _) {
          final filteredRecords = searchText.isEmpty
              ...
              : records.where((record) => 
                  record.name.toLowerCase().contains(searchText.toLowerCase())).toList();
                ...
                children: [
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (context, homeworkCompleted, _) => Checkbox(
                      ...
                      onChanged: (value) {
                        student.homeworkCompletedNotifier.value = value ?? false;
                      },
                    ),
                  ),
                ],
