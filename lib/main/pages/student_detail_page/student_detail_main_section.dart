...
// Global key 供外部訪問
final GlobalKey<_StudentDetailMainSectionState> studentDetailFormKey =
    GlobalKey<_StudentDetailMainSectionState>();
...
class _StudentDetailMainSectionState extends State<StudentDetailMainSection>
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.studentDetail.id == null) {
        final id = await GetIt.instance<StudentsRepo>().create(
          StudentDetail(
            id: null,
            name: _name!,
            classLocation: _classLocation!,
  ...
  Padding _actionBar(BuildContext context, StudentDetailState state) {
    return Padding(
      padding: EdgeInsets.symmetric(
          horizontal: FlutterFlowTheme.of(context).spaceXLarge.h),
      child: Row(
