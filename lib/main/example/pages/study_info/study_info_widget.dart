...
import 'study_info_model.dart';
export 'study_info_model.dart';

class StudyInfoWidget extends StatefulWidget {
  const StudyInfoWidget({super.key});

  @override
  State<StudyInfoWidget> createState() => _StudyInfoWidgetState();
}

class _StudyInfoWidgetState extends State<StudyInfoWidget> {
  late StudyInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudyInfoModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'StudyInfo'});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: wrapWithModel(
                        model: _model.nameTextFieldModel,
                        updateCallback: () => safeSetState(() {}),
