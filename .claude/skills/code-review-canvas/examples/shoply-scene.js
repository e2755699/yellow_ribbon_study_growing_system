  ...
  // the platform band, so search/payments/notifications take cyan, amber and
  // green — maximally separated hues. Red is reserved and never a plane. Shape carries ownership: dashed = an
  ...
  const PLANES = {
    ...
    payments: { c: '#FBBF24', label: 'Payments plane' },
